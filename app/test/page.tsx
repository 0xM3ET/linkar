...
export default function Component() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-purple-50 flex items-center justify-center ">
            ...
            <main className="container px-28 py-16 border-2">
                ...
                <section className="my-24 text-center">
                    ...
                    <Link href='/profile'>
                        <button className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 font-semibold text-primary-foreground hover:bg-primary/90">
                            Get Started
